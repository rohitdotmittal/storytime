...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'story_choices', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal(u'story', ['Choices'])

        # Adding model 'FashionItem'
        db.create_table(u'story_fashionitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'story', ['FashionItem'])

        # Adding model 'Profile'
        db.create_table(u'story_profile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True, blank=True)),
        ))
        db.send_create_signal(u'story', ['Profile'])

        # Adding M2M table for field the_choices on 'Profile'
        m2m_table_name = db.shorten_name(u'story_profile_the_choices')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profile', models.ForeignKey(orm[u'story.profile'], null=False)),
            ('choices', models.ForeignKey(orm[u'story.choices'], null=False))
        ))
        db.create_unique(m2m_table_name, ['profile_id', 'choices_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'story_choices')

        # Deleting model 'FashionItem'
        db.delete_table(u'story_fashionitem')

        # Deleting model 'Profile'
        db.delete_table(u'story_profile')

        # Removing M2M table for field the_choices on 'Profile'
        db.delete_table(db.shorten_name(u'story_profile_the_choices'))
    ...
    models = {
        ...
        u'story.profile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'the_choices': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['story.Choices']", 'symmetrical': 'False'}),
